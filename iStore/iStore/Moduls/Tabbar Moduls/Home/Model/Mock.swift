...
struct MockData {
    ...
    private let searchField: Section = {
    ...
    private let products: Section = {
        .products([.init(image: "img", categories: "", products: "", title: "tv LG", price: "$199.99"),
                   ...
                   .init(image: "img", categories: "", products: "", title: "Airpoods pro", price: "$499.99"),
                   .init(image: "img", categories: "", products: "", title: "Playstation 4", price: "$1999.99"),
                   .init(image: "img", categories: "", products: "", title: "tv LG", price: "$199.99"),
                   .init(image: "img", categories: "", products: "", title: "Aestechic mug", price: "$19.99"),
                   .init(image: "img", categories: "", products: "", title: "Airpoods pro", price: "$499.99"),
                   .init(image: "img", categories: "", products: "", title: "Playstation 4", price: "$1999.99"),
        ])
